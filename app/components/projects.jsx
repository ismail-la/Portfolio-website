    ...
    <section id="projects" className="projects">
      ...
      <div className="projects-container">
        ...
        >
          ...
          <a href="https://github.com/ismail-la/E-commerce-MVP" target="_blank">
            <div className="icon">
        ...
        >
          ...
          <a href="https://github.com/ismail-la/AirBnB_clone" target="_blank">
            <div className="icon">
              <BsFillArrowUpRightCircleFill
                size={100}
                style={{ fill: "url(#gradient)" }}
        ...
        >
          <Image src={project7} width={0} height={0} />
          <a href="" target="_blank">
            <div className="icon">
              <BsFillArrowUpRightCircleFill
                size={100}
